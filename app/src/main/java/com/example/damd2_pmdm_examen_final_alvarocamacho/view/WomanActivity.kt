...
import com.example.damd2_pmdm_examen_final_alvarocamacho.databinding.ActivityWomanBinding
import com.example.damd2_pmdm_examen_final_alvarocamacho.viewModel.ProductViewModel

class WomanActivity : AppCompatActivity() {
    private lateinit var binding: ActivityWomanBinding
    private lateinit var viewModel: ProductViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityWomanBinding.inflate(layoutInflater)
